...
function Register() {
  ...
  const { apiUrl, isLoading, setIsLoading, password, setPassword,email,setEmail } = useContext(storeContext);
      ...
      <div className="mx-auto max-w-screen px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-lg">
          <h1 className="text-center text-2xl font-bold text-primary sm:text-3xl">
            Register on our hospital app
          </h1>

          <p className="mx-auto mt-4 max-w-md text-center text-gray-500">
            Register to make an appointment with us today.
          </p>
